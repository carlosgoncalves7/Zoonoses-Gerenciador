...
('Ana Paula Ribeiro', 'ana.ribeiro@empresa.com', '123456'),
('Marcos Vinicius Santos', 'marcos.santos@empresa.com', 'senha123'),
...
INSERT INTO animais (nome,especie,raca,idade,peso,cor,sexo,id_tutor,id_funcionario_cadastro)
	VALUES
	('Rex', 'Cachorro', 'Labrador', 5, 28.5, 'Caramelo', 'Macho', 1, 1),
	('Mimi', 'Gato', 'Siamês', 3, 4.2, 'Branco','Fêmea', 2, 2),
	('Thor', 'Cachorro', 'Pastor Alemão', 7, 35.0, 'Preto e Marrom','Macho', 3, 1),
	('Luna', 'Gato', 'Persa', 2, 3.8, 'Cinza', 'Fêmea', 4, 3),
	('Bob', 'Cachorro', 'Bulldog Francês', 4, 12.3, 'Branco e Preto', 'Macho', 5, 2),
	('Mel', 'Cachorro', 'Pinscher', 1, 2.1, 'Marrom', 'Fêmea', NULL, 1),
...
(12345, 'Drª. Mariana Silva', 'mariana.silva@vet.com'),
(67890, 'Drª. Beatriz Souza', 'beatriz.souza@vet.com'),
(54321, 'Drª. Juliana Costa', 'juliana.costa@vet.com');
    
INSERT INTO procedimentos (nome, descricao, data_procedimento, id_veterinario, id_tutor, id_animal) VALUES
('Castração', 'Procedimento cirúrgico de castração (Orquiectomia) - Macho', '2026-06-02', 1, 1, 1),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-02', 2, 2, 2),
('Castração', 'Procedimento cirúrgico de castração (Orquiectomia) - Macho', '2026-06-02', 3, 3, 3),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-03', 1, 4, 4),
('Castração', 'Procedimento cirúrgico de castração (Orquiectomia) - Macho', '2026-06-03', 2, 5, 5),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-03', 3, 6, 8),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-04', 1, 7, 10),
('Castração', 'Procedimento cirúrgico de castração (Orquiectomia) - Macho', '2026-06-04', 2, 11, 11),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-04', 3, 14, 12),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-05', 1, 18, 13),
('Castração', 'Procedimento cirúrgico de castração (Orquiectomia) - Macho', '2026-06-05', 2, 22, 14),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-05', 3, 25, 15),
('Castração', 'Procedimento cirúrgico de castração (Orquiectomia) - Macho', '2026-06-08', 1, 29, 16),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-08', 2, 31, 17),
('Castração', 'Procedimento cirúrgico de castração (Orquiectomia) - Macho', '2026-06-08', 3, 35, 18),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-09', 1, 12, 19),
('Castração', 'Procedimento cirúrgico de castração (Orquiectomia) - Macho', '2026-06-09', 2, 17, 20),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-09', 3, 20, 21),
('Castração', 'Procedimento cirúrgico de castração (Orquiectomia) - Macho', '2026-06-10', 1, 27, 22),
('Castração', 'Procedimento cirúrgico de castração (Orquiectomia) - Macho', '2026-06-10', 2, 33, 23),
('Castração', 'Procedimento cirúrgico de castração (Ovariohisterectomia) - Fêmea', '2026-06-10', 3, 15, 24),
